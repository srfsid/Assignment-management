...
$pquery = sprintf("SELECT Link FROM images WHERE UserType = '2' AND ID = '%d';",mysqli_real_escape_string($link,$_SESSION['user_id']));
...
?>
	<table>
		<tbody>
			...
			<tr>
				<td><strong>Registration no.</strong></td><td><?php echo $result[3];?></td>
			</tr>
			<tr>
				<td><strong>Email</strong></td><td><?php echo $result[5];?></td>
			</tr>
			<tr>
				<td><strong>Department</strong></td><td><?php echo $result[6];?></td>
			</tr>
			<tr>
				<td></td>
				<td><a href="chng_pass_s.php">Change Password</a></td>
			</tr>
		</tbody>
	</table>
<?php	
